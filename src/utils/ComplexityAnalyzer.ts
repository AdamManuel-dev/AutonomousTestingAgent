...
export class ComplexityAnalyzer {
   ...
   */
  private getFunctionName(node: ts.FunctionDeclaration | ts.FunctionExpression | ts.ArrowFunction): string {
  ...
  async compareComplexity(
    ...
    const percentageChange = previousReport.totalComplexity > 0
      ? (change / previousReport.totalComplexity) * 100
      : 0;
